...
namespace foray::irradiance_cache {
    ...
    void
    IrradianceCacheFillStage::RecordFrameBarriers(VkCommandBuffer cmdBuffer, base::FrameRenderInfo &renderInfo, std::vector<VkImageMemoryBarrier2> &imageFullBarriers,
